export const FALLBACK_CONTENT = {
  ...
  contact: { eyebrow:'Get In Touch', title:"Let's talk media.", address:'12 Aperture Lane, Victoria Island, Lagos, Nigeria', email:'hello@liora.media', phone:'+234 800 000 0000', instagram:'@lioramedia', instagramUrl:'#', note:'Update these details from the admin dashboard whenever they change.' },
